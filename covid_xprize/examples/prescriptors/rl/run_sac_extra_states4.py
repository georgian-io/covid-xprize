...
country = "Canada"#sys.argv[1] #"Canada"
...
writer = SummaryWriter(f'dqn-agent-results/sac3_lr1e-2{country}')
...
torch.save(policy.state_dict(), f"{path_to_xprize + save_dir}/sac3_{country}.pth")
policy.load_state_dict(torch.load(f'{path_to_xprize + save_dir}/sac3_{country}.pth'))
